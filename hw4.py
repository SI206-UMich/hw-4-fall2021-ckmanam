...
class Customer: 
    ...
    def submit_order(self, cashier, stall, amount): 
        self.wallet -= amount
        self.receive_payment(cashier, stall, amount)
...
def main():
    ...
    inventory_1 = {"Burrito":100, "Hot Dog":50, "Pizza": 75}
    inventory_2 = {"Salad": 50, "Chips Bags": 0, "Croissant": 70}

    c1 = Customer("Rachel", wallet=0) 
    c2 = Customer("Jasmine", wallet=100)
    c3 = Customer("Hannah", wallet=50)

    s1 = Stall("Chipotle", inventory_1, cost=10)
    s2 = Stall("McDonalds", inventory_2, cost=5)

    ca1 = Cashier("Mark", directory = ["Chipotle", "McDonalds"])
    ca2 = Cashier("Steve", directory = ["McDonalds", "Pizza Hut"])

    print("-----")

    ca1.has_stall("Chipotle")
